...
exports.getDiscussionByWorkspaceId = async ( req, res ) => {
    ...
    res.set( "x-gormanly-message-detail", "Returned discussion with comments" );
...
exports.updateDiscussionByWorkspaceId = async ( req, res ) => {
    ...
    res.set( "x-gormanly-message-title", "Success" );
    res.set( "x-gormanly-message-detail", "Updated discussion" );
    res.status( 200 ).json( discussion );
};
...
exports.createDiscussionByWorkspaceId = async ( req, res ) => {
    ...
    res.set( "x-gormanly-message-title", "Success" );
    res.set( "x-gormanly-message-detail", "Created discussion" );
...
exports.createComment = async ( req, res ) => {
    ...
    res.set( "x-gormanly-message-title", "Success" );
    res.set( "x-gormanly-message-detail", "Created comment" );
...
exports.editComment = async ( req, res ) => {
    ...
    res.set( "x-gormanly-message-title", "Success" );
    res.set( "x-gormanly-message-detail", "Edited comment" );
    res.status( 200 ).json( comment );
};
...
exports.deleteComment = async ( req, res ) => {
    ...
    res.set( "x-gormanly-message-title", "Success" );
    res.set( "x-gormanly-message-detail", "Deleted Comment" );
    res.status( 200 ).json( comment );
};
...
exports.setRating = async ( req, res ) => {
    ...
    res.set( "x-gormanly-message-title", "Success" );
    res.set( "x-gormanly-message-detail", "Set Rating" );
...
exports.removeRating = async ( req, res ) => {
    ...
    res.set( "x-gormanly-message-title", "Success" );
    res.set( "x-gormanly-message-detail", "Removed Rating" );
    res.status( 200 ).json( rating );
};