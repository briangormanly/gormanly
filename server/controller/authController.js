...
exports.googleSignIn = async function( req, res ) {
    ...
    if( req.body.credential ) {
        ...
        if( user ) {
            ...
            req.session.messageBody = "You are not currently registered with gormanly. You can sign up either with your Google account by filling out the informtion in the form</a>";
            ...
            if( process.env.EMAIL_TOGGLE == "true" ) {
                ...
                const mailOptions = {
                    ...
                    html: "<p>Hello, we hope this email finds you well!</p>"
                        ...
                        + "<p>Carpe Diem!</p>"
                        + "<p>The gormanly Team</p>", // plain text body
                };
