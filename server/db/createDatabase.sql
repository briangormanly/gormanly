-- gormanly base database setup
-- CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- setup (as root / postgres)
drop database gormanly;
create database gormanly;
create user gormanly with encrypted password 'gormanly';
grant all privileges on database gormanly to gormanly;
grant connect on database gormanly to gormanly;
GRANT ALL ON SCHEMA public TO gormanly;
...
GRANT ALL PRIVILEGES ON TABLE users TO gormanly;
--GRANT USAGE, SELECT ON SEQUENCE users_user_id_seq TO gormanly;
...
GRANT ALL PRIVILEGES ON TABLE session TO gormanly;
...
GRANT ALL PRIVILEGES ON TABLE user_sessions TO gormanly;
CREATE INDEX IF NOT EXISTS idx_user_sessions_user_id ON user_sessions (user_id);
GRANT USAGE, SELECT ON SEQUENCE user_sessions_user_session_id_seq TO gormanly;
...
GRANT ALL PRIVILEGES ON TABLE roles TO gormanly;
GRANT USAGE, SELECT ON SEQUENCE roles_role_id_seq TO gormanly;
...
GRANT ALL PRIVILEGES ON TABLE user_roles TO gormanly;
GRANT USAGE, SELECT ON SEQUENCE user_roles_user_role_id_seq TO gormanly;
...
GRANT ALL PRIVILEGES ON TABLE tags TO gormanly;
GRANT USAGE, SELECT ON SEQUENCE tags_tag_id_seq TO gormanly;
...
GRANT ALL PRIVILEGES ON TABLE discussions TO gormanly;
...
GRANT ALL PRIVILEGES ON TABLE discussion_comments TO gormanly;
...
GRANT ALL PRIVILEGES ON TABLE discussion_comment_ratings TO gormanly;
